...
Подключаемся через терминал командой типа `ssh user@51.333.111.22`  где user это имя пользователя, 51.333.111.22  адрес назначеный VM при создании. Водим пароль указаный при создании  ssh-ключа.

```
ssh user@51.333.111.22
```

*ip: 51.333.111.22 - приведен для примера*
...
Загрузка и установка Swift - новый способ
...
и далее выбираем установку по умолчанию





Загрузка и установка Swift - старый способ
...
Посмотреть пользователей зарегистрированных в системе можно посмотреть в файле /etc/passwd
